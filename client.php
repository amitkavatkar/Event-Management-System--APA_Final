		...
		<div class="row">
			...
			<div class="col-10">
				...
				<table class="table table-striped table-sm">
					...
					<tbody>
					<?php
						$sql = "SELECT ID, Name, Phone, Address, TypeEvent FROM enquiery ";
								
						$result = mysqli_query($con, $sql); 
						if (mysqli_num_rows($result) > 0) {
							// output data of each row
							while($row = mysqli_fetch_assoc($result)) {
								echo "<tr><td>" . $row["ID"]. "</td>". "</td><td>" . $row["Name"]. "</td>". "</td><td>" . $row["Phone"]. "</td>". "</td><td>" . $row["Address"]. "</td></td>". "</td><td>" . $row["TypeEvent"]. "</td>";
							}
						} else {
