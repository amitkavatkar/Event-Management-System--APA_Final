		...
		<div class="row">
			...
			<div class="col-10">
				...
				<table class="table table-striped table-sm">
					...
					<tbody>
					<?php
						$sql = "SELECT eventID, customerID, catererID, venueID, decoraterID, performerID, enquiery.Name, enquiery.Phone, enquiery.TypeEvent FROM event ".
								"INNER JOIN enquiery ON event.customerID = enquiery.ID";
						$result = mysqli_query($con, $sql); 
						if (mysqli_num_rows($result) > 0) {
							// output data of each row
							while($row = mysqli_fetch_assoc($result)) {
								echo "<tr><td>" . $row["eventID"]. "</td>". "</td><td>" . $row["catererID"]. "</td>". "</td><td>" . $row["venueID"]. "</td>". "</td><td>" . $row["decoraterID"]. "</td></td>". "</td><td>" . $row["performerID"]. "</td></td>". "</td><td>" . $row["Name"]. "</td></td>". "</td><td>" . $row["Phone"]. "</td></td>". "</td><td>" . $row["TypeEvent"]. "</td>";
							}
						} else {
